...
import com.jp.myshop.util.SessonFactoryOrder;
...
public class MyshopDaoImpl implements MyShopDao{
	...
	public void sellItem(List <OrderDto> products) {
		...
		Session stockSesson = SessonFactoryStock.getSessionFactory().openSession();
		...
		for (OrderDto prod : products) {
			...
			Session productSession = SessonFactoryProduct.getSessionFactory().openSession();
			...
			Session orderSession = SessonFactoryOrder.getSessionFactory().openSession();
	...
	public Object getById(long altKey) {
		...
		Session prodSession = SessonFactoryProduct.getSessionFactory().openSession();
